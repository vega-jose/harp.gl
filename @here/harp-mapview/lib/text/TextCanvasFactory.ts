...
export class TextCanvasFactory {
    private m_minGlyphCount: number; // Min amount of glyphs each [[TextCanvas]] layer can store.
    private m_maxGlyphCount: number; // Max amount of glyphs each [[TextCanvas]] layer can store.
    ...
    constructor(private readonly m_renderer: THREE.WebGLRenderer) {
        this.m_minGlyphCount = 0;
        this.m_maxGlyphCount = 0;
    }
