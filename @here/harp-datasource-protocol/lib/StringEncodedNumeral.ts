...
export const StringEncodedMetricFormatMaxSize = StringEncodedMetricFormats.reduce(
...
export const StringEncodedColorFormatMaxSize = StringEncodedColorFormats.reduce(
    (a, b) => Math.max(a, b.size),
    0
);
