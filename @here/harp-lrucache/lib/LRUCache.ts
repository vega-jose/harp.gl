...
export class LRUCache<Key, Value> {
     ...
     *
     * The optional [[sizeFunction]] can be used to fine tune the memory consuption of all cached
     ...
     * number of entries or memory consumed in megabytes depending from [[sizeFunction]].
     ...
     * althought modify the current element in [[callbackfn]] function.
     *
