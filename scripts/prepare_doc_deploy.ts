...
mkdirSync("dist/gh_deploy", { recursive: true });
...
mkdirSync(`dist/s3_deploy/${folderName}`, { recursive: true });
moveSync("dist/doc/*", `dist/s3_deploy/${folderName}`);
//moveSync("dist/examples", `dist/s3_deploy/${folderName}`);
